...
export const colorHash = {
  ...
  '10':   { mask: '!.:', val: 11,   name: 'ра',  rgb: '250,175,200' },
  '-10':  { mask: '!.:', val: -11,  name:  'ру', rgb: '125,75,100'  },
  ...
  '6':   { mask: '_!_', val: 6,   name: 'жа', rgb: '25,250,25'   },
  '-6':  { mask: '_!_', val: -6,  name: 'жу', rgb: '25,100,25'   },

  '5':   { mask: '!:_', val: 5,  name: 'ла',  rgb: '250,175,25'   },
  '-5':  { mask: '!:_', val: -5,  name: 'лу',  rgb: '125,75,25'    },

  '4':   { mask: '!!_', val: 4,   name: 'са', rgb: '250,250,25'   },
  '-4':  { mask: '!!_', val: -4,  name: 'су', rgb: '125,125,25'   },

  '3':  { mask: '.!:', val: 3,  name: 'ра', rgb: '150,250,200'  },
  '-3': { mask: '.!:', val: -3,  name: 'ру', rgb: '50,150,100'   },

  '2':   { mask: '.:!', val: 2,  name: 'ша', rgb: '150,200,250'  },
  '-2':  { mask: '.:!', val: -2,   name: 'шу', rgb: '50,100,150'   },
