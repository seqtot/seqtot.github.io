...
export const colorHash = {
  ...
  '-12':  { mask: '!__', val: -12,   name: 'йу',  rgb: '175,25,25'   },
  // 0,0,125 - 75,75,250
  '11':   { mask: '__!', val: 11,  name: 'га',      rgb: '75,75,250'    },
  '-11':  { mask: '__!', val: -11,  name: 'гу',      rgb: '0,0,125'   },
  // 100,75,125 - 200,150,250
  '10':  { mask: ':.!', val: 10, name: 'ра',  rgb: '200,150,250' },
  '-10': { mask: ':.!', val: -10, name:  'ру', rgb: '100,75,125'  },
  // 0,125,125 - 0,250,250
  '9':   { mask: '_!!', val: 9,  name: 'фа', rgb: '0,250,250'   },
  '-9':  { mask: '_!!', val: -9,  name: 'фу', rgb: '0,125,125'   },
  // 125,75,100 - 250,175,200
  '8':   { mask: '!.:', val: 8,   name: 'ва',  rgb: '250,175,200' },
  '-8':  { mask: '!.:', val: -8,  name:  'ву', rgb: '125,75,100'  },
  // 120,25,125 - 250,25,250
  '7':   { mask: '!_!', val: 7,   name: 'за', rgb: '250,25,250'  },
  '-7':  { mask: '!_!', val: -7,   name: 'зу', rgb: '120,25,125'  },
  // 25,100,25 - 25,250,25
  '6':   { mask: '_!_', val: 6,   name: 'ша', rgb: '25,250,25'   },
  '-6':  { mask: '_!_', val: -6,  name: 'шу', rgb: '25,100,25'   },
  // 125,75,25 - 250,175,25
  '5':   { mask: '!:_', val: 5,  name: 'ла',  rgb: '250,175,25'   },
  '-5':  { mask: '!:_', val: -5,  name: 'лу',  rgb: '125,75,25'    },
  // 125,125,25 - 250,250,25
  '4':   { mask: '!!_', val: 4,   name: 'жа', rgb: '250,250,25'   },
  '-4':  { mask: '!!_', val: -4,  name: 'жу', rgb: '125,125,25'   },
  // 50,150,100 - 150,250,200
  '3':  { mask: '.!:', val: 3,  name: 'ща', rgb: '150,250,200'  },
  '-3': { mask: '.!:', val: -3,  name: 'щу', rgb: '50,150,100'   },
  // 50,100,150 - 150,200,250
  '2':   { mask: '.:!', val: 2,  name: 'са', rgb: '150,200,250'  },
  '-2':  { mask: '.:!', val: -2,   name: 'су', rgb: '50,100,150'   },
  // 100,100,110 - 200,190,190
