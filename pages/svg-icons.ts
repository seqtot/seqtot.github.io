...
export function wavBtn(data: string, color= 'black', size = 20) {
    data = (data || '').trim();
    color = (color || '').trim() || 'black';
    ...
    return `
        <span style="${svgIconBtnStl}" ${data}>
            <svg 
                width="${size}px" height="${size}px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"
                style="fill: ${color}; stroke: none;"                
            >
                <g>
                    <g>
...
export function playAndSaveBtn(data: string, color= 'black', size = 20) {
    data = (data || '').trim();
    color = (color || '').trim() || 'black';
    ...
    return `
        <span style="${svgIconBtnStl}" ${data}>
            <svg 
                width="${size}px" height="${size}px" viewBox="0 0 370.32 370.32" xmlns="http://www.w3.org/2000/svg"
                style="fill: ${color}; stroke: none;"
            >
                <g>
