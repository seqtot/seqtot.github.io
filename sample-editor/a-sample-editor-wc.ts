...
export class SampleEditorWc extends CustomElement {
  ...
  private _rootHolder: RootComponentHolder<SampleEditorRootCc>;
  private readonly _model: SequencerDisplayModel;
  private readonly _sequencerRoot: SampleEditorRootCc;
  ...
  constructor() {
    ...
    this._sequencerRoot = new SampleEditorRootCc(this._model, this.ee);
    this._rootHolder = new RootComponentHolder<SampleEditorRootCc>(
      100,
      100,
      this._sequencerRoot
    );
  ...
  public static get observedAttributes(): string[] {
    return [SampleEditorWc.TIME_START, 'duration', 'pitch-start', 'pitch-end'];
  }
  ...
  public set atomInQuarter(val: number) {
    ...
    this.setAttribute(SampleEditorWc.ATOM_IN_QUARTER, val.toString());
  }
  ...
  public set timeStart(value: number) {
    ...
    this.setAttribute(SampleEditorWc.TIME_START, numberValue.toString());
  }
  ...
  public set duration(newValue: number) {
    ...
    this.setAttribute(SampleEditorWc.DURATION, numberValue.toString());
  }
  ...
  public set theme(value: string) {
    ...
    this.setAttribute(SampleEditorWc.THEME, value);
    this.draw();
  }
