...
class Ticker {
  constructor(ctx /*AudioContext*/) {
    ...
    tickByBeatsMs(
      params /*beatsWithOffsetMs?: number[], startTimeSec?: number*/,
      cb /*() => void*/
    ) {
    ...
    start(
      params /* beatsWithOffsetMs?: number[], bpm?: number, startTimeSec?: number*/,
      cb /*() => void*/
    ) {
        let started = false;
    ...
    tickByBpm(
      params /* bpm: number, startCtxTimeSec?: number*/,
      cb /*() => void*/
    ) {
        ...
        */
        ...
        offlineCtx
            ...
            .then(audioBuffer => {
                ...
                this.tickSource = audioBufferSourceNode;
                ...
                audioBufferSourceNode.onended = () => {
                    //console.log('onended');
                    audioBufferSourceNode.disconnect(Sound.ctx); // Sound.ctx.destination
                    this.tickSource = null;
