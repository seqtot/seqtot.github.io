...
import { ThereminPage2 } from '../pages/theremin/theremin2.page';
...
const isDevUser =
  UserSettingsStore.GetUserSettings().userName === 'dev' || isDev;
// const isDev =
...
const defRoute = isDev ? '/page/theremin2/' : '/song_list/bandit';
...
const linksToPage: Link[] = [
  ...
  { href: '/page/theremin2', name: 'Theremin2' },
